...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        cleanTile = (x, y)
        if cleanTile not in self.cleanedTile:
            self.cleanedTile.append(cleanTile)
    ...
    def isTileCleaned(self, m, n):
        ...
        return tile in self.cleanedTile
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.room = room
        self.speed = speed
        #initialize a random direction and a random position
        self.robotPosition = self.room.getRandomPosition()
        self.robotDirection = random.choice(range(360))
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    while num> 0:
        ...
        i = num_robots  # if don't assign num_robots to a variable, it will be a infinit loop. why?
        robots = []
        while i > 0:
...
def showPlot2(title, x_label, y_label):
    ...
    pylab.ylabel(y_label)
    pylab.show()
print showPlot1('rumSimulation', 'num_robot', 'times')
